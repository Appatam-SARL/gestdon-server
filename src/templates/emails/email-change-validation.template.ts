...
interface EmailChangeValidationTemplateProps {
  firstName: string;
...
export const getEmailChangeValidationTemplate = ({
  firstName,
  validationUrl,
  oldEmail,
  newEmail,
}: EmailChangeValidationTemplateProps): EmailTemplate => {
  return {
    subject: "Validation de changement d'email - ValDeli",
    html: `
      <!DOCTYPE html>
      <html>
        <head>
        ...
        <body>
          <div class="container">
            ...
            <div class="content">
              ...
              <p>Vous avez demandé à changer votre adresse email sur ValDeli :</p>
              <ul>
                <li>Ancien email : ${oldEmail}</li>
                <li>Nouvel email : ${newEmail}</li>
              </ul>
              ...
              <p style="text-align: center;">
                <a href="${validationUrl}" class="button">Valider le changement d'email</a>
              </p>
    ...
    text: `
      ...
      Vous avez demandé à changer votre adresse email sur ValDeli :
